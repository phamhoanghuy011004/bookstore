                    ...
                    <ul>
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/contact') }}">Main Street, Melbourne, Australia</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                        ...
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/contact') }}">Mod-friday, 09am -05pm</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                            <div class="offcanvas__contact-icon mr-15">
            ...
            <div class="modal-body">
                ...
                <div class="identityBox">
                    <div class="form-wrapper">
                        ...
                        <input class="inputField" type="text" name="name" id="name1" placeholder="User Name">
                        <input class="inputField" type="email" name="email" placeholder="Email Address">
                        <input class="inputField" type="password" name="password" placeholder="Enter Password">
...
<div class="map-section">
    <div class="map-items">
        <div class="googpemap">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1627.269062265936!2d105.78203698864935!3d21.028127594985236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b3285df81f%3A0x97be82a66bbe646b!2sDetech%20Building!5e0!3m2!1svi!2s!4v1724556605597!5m2!1svi!2s"
