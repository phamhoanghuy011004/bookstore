                    ...
                    <ul>
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/about') }}">Main Street, Melbourne, Australia</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                        ...
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/about') }}">Mod-friday, 09am -05pm</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                            <div class="offcanvas__contact-icon mr-15">
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="about-image">
                        <img src="https://res.cloudinary.com/dficfkyug/image/upload/v1724839989/qublrxkyxpiwgee8m8ig.jpg" alt="img">
                        {{--                            <div class="video-box">--}}
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        ...
                        <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                            Bookle was founded in 2024 with the mission of connecting readers with the best quality
                            books. Initiated by the founding team's passion for books, we quickly expanded and developed
                            to meet the growing needs of readers. Although a new business, we have constantly strived
                            to build a reputable brand and bring real value to customers by providing excellent books and services.
                        </p>
                        <p class="mt-3 wow fadeInUp" data-wow-delay=".7s">
                            Bookle is committed to providing the highest quality and most diverse books to serve
                            everyone's reading needs. We are dedicated to selecting new and interesting books, in
                            order to bring customers great reading experiences.
                            We aim to become one of the leading online book suppliers in Vietnam. With the outstanding
                            goal of providing excellent customer service and a rich product category, we hope to connect
                            readers with their favorite books and contribute to enriching their literary world.
                        </p>
                        {{--                            <a href="{{ url('/about') }}" class="link-btn wow fadeInUp" data-wow-delay=".8s">Overview <i--}}
