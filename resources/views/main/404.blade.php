                    ...
                    <ul>
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/404') }}">Main Street, Melbourne, Australia</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                        ...
                        <li class="d-flex align-items-center">
                            ...
                            <div class="offcanvas__contact-text">
                                <a target="_blank" href="{{ url('/404') }}">Mod-friday, 09am -05pm</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                            <div class="offcanvas__contact-icon mr-15">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul class="submenu">
                                                    <li><a href="{{ url('/news-grid') }}">Blog Grid</a></li>
                                                    <li><a href="{{ url('/news') }}">Blog List</a></li>
                                                    <li><a href="{{ url('/news') }}">Blog Details</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="{{ url('/contact') }}">Contact</a>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="error-items">
                    ...
                    <a href="{{ url('/index') }}" class="theme-btn wow fadeInUp" data-wow-delay=".8s">
                        Back to Home Pages
